...
AK_FINE_PROGRESS_LEN	equ 260504
AK_SMP_LEN				equ 200970
AK_EXT_SMP_LEN			equ 15241
...
.NoClone_9_1
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_0
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_0
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#557<<1,d5
				ble.s	.NoReverbReset_9_2_0
				moveq	#0,d5
.NoReverbReset_9_2_0
				move.w  d5,AK_OpInstance+0(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_1
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_1
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#593<<1,d5
				ble.s	.NoReverbReset_9_2_1
				moveq	#0,d5
.NoReverbReset_9_2_1
				move.w  d5,AK_OpInstance+2(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_2
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_2
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#641<<1,d5
				ble.s	.NoReverbReset_9_2_2
				moveq	#0,d5
.NoReverbReset_9_2_2
				move.w  d5,AK_OpInstance+4(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_3
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_3
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#677<<1,d5
				ble.s	.NoReverbReset_9_2_3
				moveq	#0,d5
.NoReverbReset_9_2_3
				move.w  d5,AK_OpInstance+6(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_4
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_4
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#709<<1,d5
				ble.s	.NoReverbReset_9_2_4
				moveq	#0,d5
.NoReverbReset_9_2_4
				move.w  d5,AK_OpInstance+8(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_5
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_5
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#743<<1,d5
				ble.s	.NoReverbReset_9_2_5
				moveq	#0,d5
.NoReverbReset_9_2_5
				move.w  d5,AK_OpInstance+10(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_6
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_6
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#787<<1,d5
				ble.s	.NoReverbReset_9_2_6
				moveq	#0,d5
.NoReverbReset_9_2_6
				move.w  d5,AK_OpInstance+12(a5)
				move.w	d4,d7
				...
				asr.l	#7,d4
				add.w	d0,d4
				bvc.s	.ReverbAddNoClamp_9_2_7
				spl		d4
				ext.w	d4
				eor.w	#$7fff,d4
.ReverbAddNoClamp_9_2_7
				move.w	d4,(a4,d5.w)
				addq.w	#2,d5
				cmp.w	#809<<1,d5
				ble.s	.NoReverbReset_9_2_7
				moveq	#0,d5
.NoReverbReset_9_2_7
				move.w  d5,AK_OpInstance+14(a5)
				move.w	d4,d7
				...
				move.l	a6,d7
				cmp.l	#32767,d7
				ble.s	.NoReverbMax_9_2
				move.w	#32767,d7
				bra.s	.NoReverbMin_9_2
.NoReverbMax_9_2
				cmp.l	#-32768,d7
				bge.s	.NoReverbMin_9_2
				move.w	#-32768,d7
.NoReverbMin_9_2
				move.w	d7,d0
				move.l	(sp)+,d7
...
;----------------------------------------------------------------------------
; Instrument 10 - Loop Generator (Offset: 1670 Length: 2
;----------------------------------------------------------------------------
...
;----------------------------------------------------------------------------
; Instrument 11 - Loop Generator (Offset: 2358 Length: 2
;----------------------------------------------------------------------------
...
;----------------------------------------------------------------------------
; Instrument 12 - Virgill_BassStab1
;----------------------------------------------------------------------------
...
;----------------------------------------------------------------------------
; Instrument 13 - Virgill_BassStab2
;----------------------------------------------------------------------------
...
;----------------------------------------------------------------------------
; Instrument 14 - Virgill_BassStab3
;----------------------------------------------------------------------------
...
.NoClampLPF_14_2
				...
				sub.l	d6,d5
				cmp.l	#32767,d5
				ble.s	.NoClampMaxHPF_14_2
				move.w	#32767,d5
				bra.s	.NoClampMinHPF_14_2
.NoClampMaxHPF_14_2
				cmp.l	#-32768,d5
				bge.s	.NoClampMinHPF_14_2
				move.w	#-32768,d5
.NoClampMinHPF_14_2
				move.w	d5,AK_OpInstance+AK_HPF+0(a5)
				asr.w	#7,d5
...
AK_Vars:
				...
				dc.l	$00000938		; Instrument 11 Length 
				...
				dc.l	$00002af4		; Instrument 21 Length 
				...
				dc.l	$00001d50		; External Sample 2 Length 
				dc.l	$00000000		; External Sample 3 Length 
				dc.l	$00000000		; External Sample 4 Length 
				dc.l	$00000429		; External Sample 5 Length 
				dc.l	$00000688		; External Sample 6 Length 
				dc.l	$00000938		; External Sample 7 Length 
